...
{
    protected $fd=0,$name = '', $avatar = '',$roomid='a';
    ...
    public function save(){
        ...
        $userInfo = ['roomid'=>$this->roomid,'fd'=>$this->fd,'name'=>$this->name,'avatar'=>$this->avatar,'time'=>date("H:i",time())];
        //插入到room表，给房间增加一个用户
    ...
    public function changeUser($oldroomid,$fd,$newroomid){
        ...
        //插入到房间用户信息表
        $userInfo = ['roomid'=>$newroomid,'fd'=>$fd,'name'=>$this->name,'avatar'=>$this->avatar,'time'=>date("H:i",time())];
